...
export default function CircleCreateForm({ basePath = "/community/circles" }) {
  ...
  const submit = async (event) => {
    ...
    try {
      ...
      window.location.assign(`${basePath}/${result.slug}`);
    } catch (error) {
